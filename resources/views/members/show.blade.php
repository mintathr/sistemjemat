                ...
                <div class="lg:col-span-4 xl:col-span-3 space-y-6">
                    <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
                        ...
                        <div class="relative -mt-16 flex justify-center">
                            <div class="relative">
                                <img src="{{ $member->photo ? asset('storage/' . $member->photo) : ($member->foto ? asset('storage/' . $member->foto) : asset('storage/rr.jpeg')) }}" 
                    ...
                    <div class="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="relative p-6 rounded-2xl border-2 border-gray-100 bg-gray-50">
                                ...
                                <p class="text-xs text-gray-500 mt-1">{{ $member->tgl_nikah_gereja ? $member->tgl_nikah_gereja->format('d/m/Y') : '-' }}</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-16">
                            ...
                            <div class="group">
                                <p class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">Status Pernikahan</p>
                                <p class="text-gray-700 font-semibold">{{ $member->status_nikah ?? '-' }}</p>
                            </div>
                        </div>
